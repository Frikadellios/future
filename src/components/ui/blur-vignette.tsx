...
export const BlurVignette: React.FC<BlurVignetteProps> = ({
  ...
  return (
    <BlurVignetteContext.Provider value={{ radius, inset, transitionLength, blur }}>
      <div className={cn('relative aspect-square overflow-hidden', classname)} style={{ borderRadius: radius }}>
        {children}
      </div>
...
export const BlurVignetteArticle: React.FC<BlurVignetteArticleProps> = ({ children, classname }) => {
